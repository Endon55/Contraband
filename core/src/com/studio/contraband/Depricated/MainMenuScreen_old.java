...
import com.studio.contraband.Depricated.SplashScreen_old;

public class MainMenuScreen_old implements Screen
{
    ...
    public void show()
    {
        ...
        mainMenuImageButtonPlay.addListener(new ClickListener()
        {
           ...
           {
               ((Game)Gdx.app.getApplicationListener()).setScreen((new SplashScreen_old()));
           }
        });
    }
